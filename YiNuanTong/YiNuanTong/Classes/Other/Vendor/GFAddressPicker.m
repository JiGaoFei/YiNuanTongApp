...
- (void)dateEnsureAction {
    if (self.delegate && [self.delegate respondsToSelector:@selector(GFAddressPickerWithProvince:city:town:)]) {
        [self.delegate GFAddressPickerWithProvince:self.province city:self.city town:self.town];
    }
}
